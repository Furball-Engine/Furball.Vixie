...
namespace Furball.Vixie.Graphics.Renderers {
    public interface ITextureRenderer {
        ...
        void Draw(Texture texture, Vector2 position, Vector2? size = null, Vector2? scale = null, float rotation = 0f, Color? colorOverride = null, Rectangle? sourceRect = null, TextureFlip texFlip = TextureFlip.None);
        /// <summary>
