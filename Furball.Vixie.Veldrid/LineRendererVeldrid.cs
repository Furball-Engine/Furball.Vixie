...
namespace Furball.Vixie.Graphics.Backends.Veldrid {
    public class LineRendererVeldrid : ILineRenderer {
        ...
        public unsafe LineRendererVeldrid(VeldridBackend backend) {
            ...
            string vertexSource   = Helpers.ResourceHelpers.GetStringResource("Shaders/LineRenderer/VertexShader.glsl");
            string fragmentSource = Helpers.ResourceHelpers.GetStringResource("Shaders/LineRenderer/FragmentShader.glsl");
