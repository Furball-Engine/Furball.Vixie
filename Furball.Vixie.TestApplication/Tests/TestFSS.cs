...
namespace Furball.Vixie.TestApplication.Tests {
    public class TestFSS : GameComponent {
        ...
        public override void Draw(double deltaTime) {
            ...
            this._quadRendererGl.DrawString(this._font, "VixieFontStashSharpRenderer Testing",  new Vector2(10, 100), Color.White,     this._rotation,               new Vector2(_scale));
            this._quadRendererGl.DrawString(this._font, "More Quite Long Text, Foxes Are Cute", new Vector2(10, 200), Color.LightBlue, 2 * MathF.PI - this._rotation, new Vector2(_scale));
            this._quadRendererGl.DrawString(this._font, "Did You Know That A Bee Should Not Be Able To Fly?", new Vector2(500, 300), Color.LightGreen, MathF.PI - this._rotation, new Vector2(_scale));
