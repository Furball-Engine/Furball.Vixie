...
namespace Furball.Vixie.TestApplication.Tests {
    public class TestFSS : GameComponent {
        ...
        public override void Draw(double deltaTime) {
            ...
            this._quadRendererGl.DrawString(this._font, "Did You Know That A Bee Should Not Be Able To Fly?", new Vector2(50, 300), Color.LightGreen, (float)(Math.PI - this._rotation),       new Vector2(_scale));
